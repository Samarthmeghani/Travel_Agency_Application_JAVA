 ...
 * @author Dell
 */
public class booked_veh extends javax.swing.JFrame {
Connection con=null;
int count=0;
    /**
     * Creates new form booked_veh
     */
    public booked_veh() {
        initComponents();
        ...
        try
        {
            ...
            String query="select * from veh_details where Veh_status ='Working Issued' ;";
    ...
    private void initComponents() {
        ...
        abc.setFont(new java.awt.Font("Tahoma", 2, 18)); // NOI18N
        ...
        jLabel1.setText("Vehicle Booked");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(booked_veh.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new booked_veh().setVisible(true);
            }
        });
    }
